...
export async function PATCH(req, { params }) {
    ...
    try {
        ...
        if (body.verificationScore !== undefined) allowedUpdates.verificationScore  = body.verificationScore;
        if (body.verificationStatus !== undefined) allowedUpdates.verificationStatus = body.verificationStatus;
        if (body.collectedAt       !== undefined) allowedUpdates.collectedAt       = body.collectedAt;
